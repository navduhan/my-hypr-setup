...
-- Theme Switcher
map("n", "<leader><leader>t", "<cmd>Telescope colorscheme<cr>", { desc = "Switch Theme" })
-- Toggle Word Wrap (Alt+z or Leader+z)
map({ "n", "i" }, "<M-z>", "<cmd>set wrap!<CR>", { desc = "Toggle word wrap" })
map("n", "<leader>z", "<cmd>set wrap!<CR>", { desc = "Toggle word wrap" })
